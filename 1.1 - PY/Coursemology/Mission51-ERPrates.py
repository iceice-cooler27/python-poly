...
def calculate_card_value(card_value, time_of_entry):
    ...
    if erp_rate != 0:  #Check if there's erp charges
        if card_value >= erp_rate:              #Check if there is enough balance to pay ERP charge
            ...
            print("You do not have enough balance in your card to pay for the ERP charge.")
            print("The amount is not deducted, you need to pay a fine for this.")           #Modify to display insufficent balance in cash card
