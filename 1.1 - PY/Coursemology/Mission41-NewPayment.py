...
def cal_new_payment(age, amount):
    ...
    if age >= 60:                                               #Check if user is eligible for discount
        new_amount = amount * (1-0.05)                          #Calculate new payment amount, round up to integer
        ...
        print("You are not entilted to receive the senior citizen discount.")   #Modify to display message indicating not entitled to discount
...
print("Please pay ${:.2f}.".format(amount)) #Modify to display the amount obtained from function call
